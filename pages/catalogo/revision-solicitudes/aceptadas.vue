...
onMounted(async () => {
  ...
  storeResources.getMyTotal('publicacion', { 'filter{status}': 'published' });
  fetchNewData();
});
</script>
        ...
        <div v-if="totalResources === 0 && !isLoading" class="flex flex-contenido-centrado">
          <div class="columna-8 flex flex-contenido-centrado">
            <div class="fondo-color-acento p-3">
              ...
              <p class="m-b-0">
                No tienes solicitudes Aceptadas. Estas se añadirán cuando Aceptes alguna solicitud
                de publicación que tengas en proceso de revisión.
              </p>
            </div>
            <nuxt-link
